...
namespace DBRecipes.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, DBRecipes.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((DBRecipes.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public CategoryEntityFactory() : base("CategoryEntity", DBRecipes.EntityType.CategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public IngredientEntityFactory() : base("IngredientEntity", DBRecipes.EntityType.IngredientEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public InstructionEntityFactory() : base("InstructionEntity", DBRecipes.EntityType.InstructionEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeEntityFactory() : base("RecipeEntity", DBRecipes.EntityType.RecipeEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeCategoryEntityFactory() : base("RecipeCategoryEntity", DBRecipes.EntityType.RecipeCategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", DBRecipes.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public VersionInfoEntityFactory() : base("VersionInfoEntity", DBRecipes.EntityType.VersionInfoEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(DBRecipes.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(DBRecipes.EntityType)))
			{
				var factory = GetFactory((DBRecipes.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the DBRecipes.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(DBRecipes.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case DBRecipes.EntityType.CategoryEntity:
					return new CategoryEntityFactory();
				case DBRecipes.EntityType.IngredientEntity:
					return new IngredientEntityFactory();
				case DBRecipes.EntityType.InstructionEntity:
					return new InstructionEntityFactory();
				case DBRecipes.EntityType.RecipeEntity:
					return new RecipeEntityFactory();
				case DBRecipes.EntityType.RecipeCategoryEntity:
					return new RecipeCategoryEntityFactory();
				case DBRecipes.EntityType.UserEntity:
					return new UserEntityFactory();
				case DBRecipes.EntityType.VersionInfoEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the DBRecipes.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (DBRecipes.EntityType)Enum.Parse(typeof(DBRecipes.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((DBRecipes.EntityType)Enum.Parse(typeof(DBRecipes.EntityType), leftOperandEntityName, false), joinType, (DBRecipes.EntityType)Enum.Parse(typeof(DBRecipes.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (DBRecipes.EntityType)Enum.Parse(typeof(DBRecipes.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((DBRecipes.EntityType)entityTypeValue); }
