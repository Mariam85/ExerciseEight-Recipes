...
namespace DBRecipes.EntityClasses
{
	...
	
	{
		...
		protected class UserEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("UserEntity", InheritanceHierarchyType.None, false, (int)DBRecipes.EntityType.UserEntity, typeof(UserEntity), typeof(UserEntityFactory), false);
			}
		}
		...
		/// <remarks>Mapped on  table field: "user"."username".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 100.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
