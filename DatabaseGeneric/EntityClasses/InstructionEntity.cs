...
namespace DBRecipes.EntityClasses
{
	...
	
	{
		...
		protected class InstructionEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("InstructionEntity", InheritanceHierarchyType.None, false, (int)DBRecipes.EntityType.InstructionEntity, typeof(InstructionEntity), typeof(InstructionEntityFactory), false);
				AddNavigatorMetaData<InstructionEntity, RecipeEntity>("Recipe", "Instructions", (a, b) => a._recipe = b, a => a._recipe, (a, b) => a.Recipe = b, DBRecipes.RelationClasses.StaticInstructionRelations.RecipeEntityUsingRecipeIdStatic, ()=>new InstructionRelations().RecipeEntityUsingRecipeId, null, new int[] { (int)InstructionFieldIndex.RecipeId }, null, true, (int)DBRecipes.EntityType.RecipeEntity);
			}
		}
		...
		/// <summary> CTor</summary>
		/// <param name="recipeId">PK value for Instruction which data should be fetched into this Instruction object</param>
		/// <param name="step">PK value for Instruction which data should be fetched into this Instruction object</param>
		public InstructionEntity(System.Int32 recipeId, System.String step) : this(recipeId, step, null)
		{
		}
		...
		/// <param name="step">PK value for Instruction which data should be fetched into this Instruction object</param>
		/// <param name="validator">The custom validator object for this InstructionEntity</param>
		public InstructionEntity(System.Int32 recipeId, System.String step, IValidator validator)
		{
			InitClassEmpty(validator, null);
		...
		/// <remarks>Mapped on  table field: "instruction"."recipe_id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		...
		/// <remarks>Mapped on  table field: "instruction"."step".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 1000.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
