...
namespace DBRecipes.EntityClasses
{
	...
	
	{
		...
		protected class CategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("CategoryEntity", InheritanceHierarchyType.None, false, (int)DBRecipes.EntityType.CategoryEntity, typeof(CategoryEntity), typeof(CategoryEntityFactory), false);
				AddNavigatorMetaData<CategoryEntity, EntityCollection<RecipeCategoryEntity>>("RecipeCategories", a => a._recipeCategories, (a, b) => a._recipeCategories = b, a => a.RecipeCategories, () => new CategoryRelations().RecipeCategoryEntityUsingCategoryName, typeof(RecipeCategoryEntity), (int)DBRecipes.EntityType.RecipeCategoryEntity);
			}
		}
		...
		/// <remarks>Mapped on  table field: "category"."name".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 100.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
...
namespace DBRecipes.RelationClasses
{
	...
	{
		/// <summary>Returns a new IEntityRelation object, between CategoryEntity and RecipeCategoryEntity over the 1:n relation they have, using the relation between the fields: Category.Name - RecipeCategory.CategoryName</summary>
		public virtual IEntityRelation RecipeCategoryEntityUsingCategoryName
		{
			get { return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.OneToMany, "RecipeCategories", true, new[] { CategoryFields.Name, RecipeCategoryFields.CategoryName }); }
		}
	...
	{
		internal static readonly IEntityRelation RecipeCategoryEntityUsingCategoryNameStatic = new CategoryRelations().RecipeCategoryEntityUsingCategoryName;
