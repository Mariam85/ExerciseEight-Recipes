...
namespace DBRecipes.EntityClasses
{
	...
	
	{
		...
		protected class RecipeCategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RecipeCategoryEntity", InheritanceHierarchyType.None, false, (int)DBRecipes.EntityType.RecipeCategoryEntity, typeof(RecipeCategoryEntity), typeof(RecipeCategoryEntityFactory), false);
				AddNavigatorMetaData<RecipeCategoryEntity, CategoryEntity>("Category", "RecipeCategories", (a, b) => a._category = b, a => a._category, (a, b) => a.Category = b, DBRecipes.RelationClasses.StaticRecipeCategoryRelations.CategoryEntityUsingCategoryNameStatic, ()=>new RecipeCategoryRelations().CategoryEntityUsingCategoryName, null, new int[] { (int)RecipeCategoryFieldIndex.CategoryName }, null, true, (int)DBRecipes.EntityType.CategoryEntity);
				AddNavigatorMetaData<RecipeCategoryEntity, RecipeEntity>("Recipe", "RecipeCategories", (a, b) => a._recipe = b, a => a._recipe, (a, b) => a.Recipe = b, DBRecipes.RelationClasses.StaticRecipeCategoryRelations.RecipeEntityUsingRecipeIdStatic, ()=>new RecipeCategoryRelations().RecipeEntityUsingRecipeId, null, new int[] { (int)RecipeCategoryFieldIndex.RecipeId }, null, true, (int)DBRecipes.EntityType.RecipeEntity);
			}
		}
		...
		/// <summary> CTor</summary>
		/// <param name="categoryName">PK value for RecipeCategory which data should be fetched into this RecipeCategory object</param>
		/// <param name="recipeId">PK value for RecipeCategory which data should be fetched into this RecipeCategory object</param>
		public RecipeCategoryEntity(System.String categoryName, System.Int32 recipeId) : this(categoryName, recipeId, null)
		{
		}
		...
		/// <param name="recipeId">PK value for RecipeCategory which data should be fetched into this RecipeCategory object</param>
		/// <param name="validator">The custom validator object for this RecipeCategoryEntity</param>
		public RecipeCategoryEntity(System.String categoryName, System.Int32 recipeId, IValidator validator)
		{
			InitClassEmpty(validator, null);
		...
		/// <summary>The CategoryName property of the Entity RecipeCategory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "recipe_category"."category_name".<br/>Table field type characteristics (type, precision, scale, length): Varchar, 0, 0, 100.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
		public virtual System.String CategoryName
		{
			get { return (System.String)GetValue((int)RecipeCategoryFieldIndex.CategoryName, true); }
			set	{ SetValue((int)RecipeCategoryFieldIndex.CategoryName, value); }
		}

		/// <summary>The RecipeId property of the Entity RecipeCategory<br/><br/></summary>
		/// <remarks>Mapped on  table field: "recipe_category"."recipe_id".<br/>Table field type characteristics (type, precision, scale, length): Integer, 10, 0, 0.<br/>Table field behavior characteristics (is nullable, is PK, is identity): false, true, false</remarks>
...
namespace DBRecipes.RelationClasses
{
	...
	public partial class RecipeCategoryRelations: RelationFactory
	{
		...
		/// <summary>Returns a new IEntityRelation object, between RecipeCategoryEntity and CategoryEntity over the m:1 relation they have, using the relation between the fields: RecipeCategory.CategoryName - Category.Name</summary>
		public virtual IEntityRelation CategoryEntityUsingCategoryName
		{
			get	{ return ModelInfoProviderSingleton.GetInstance().CreateRelation(RelationType.ManyToOne, "Category", false, new[] { CategoryFields.Name, RecipeCategoryFields.CategoryName }); }
		}
	...
	{
		internal static readonly IEntityRelation CategoryEntityUsingCategoryNameStatic = new RecipeCategoryRelations().CategoryEntityUsingCategoryName;
