...
namespace DBRecipes.EntityClasses
{
	...
	
	{
		...
		protected class RecipeEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RecipeEntity", InheritanceHierarchyType.None, false, (int)DBRecipes.EntityType.RecipeEntity, typeof(RecipeEntity), typeof(RecipeEntityFactory), false);
				AddNavigatorMetaData<RecipeEntity, EntityCollection<IngredientEntity>>("Ingredients", a => a._ingredients, (a, b) => a._ingredients = b, a => a.Ingredients, () => new RecipeRelations().IngredientEntityUsingRecipeId, typeof(IngredientEntity), (int)DBRecipes.EntityType.IngredientEntity);
				AddNavigatorMetaData<RecipeEntity, EntityCollection<InstructionEntity>>("Instructions", a => a._instructions, (a, b) => a._instructions = b, a => a.Instructions, () => new RecipeRelations().InstructionEntityUsingRecipeId, typeof(InstructionEntity), (int)DBRecipes.EntityType.InstructionEntity);
				AddNavigatorMetaData<RecipeEntity, EntityCollection<RecipeCategoryEntity>>("RecipeCategories", a => a._recipeCategories, (a, b) => a._recipeCategories = b, a => a.RecipeCategories, () => new RecipeRelations().RecipeCategoryEntityUsingRecipeId, typeof(RecipeCategoryEntity), (int)DBRecipes.EntityType.RecipeCategoryEntity);
			}
		}
