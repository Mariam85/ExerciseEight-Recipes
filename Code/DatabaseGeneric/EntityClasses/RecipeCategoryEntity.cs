...
namespace DBFirst.EntityClasses
{
	...
	
	{
		...
		protected class RecipeCategoryEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("RecipeCategoryEntity", InheritanceHierarchyType.None, false, (int)DBFirst.EntityType.RecipeCategoryEntity, typeof(RecipeCategoryEntity), typeof(RecipeCategoryEntityFactory), false);
				AddNavigatorMetaData<RecipeCategoryEntity, CategoryEntity>("Category", "RecipeCategories", (a, b) => a._category = b, a => a._category, (a, b) => a.Category = b, DBFirst.RelationClasses.StaticRecipeCategoryRelations.CategoryEntityUsingCategoryNameStatic, ()=>new RecipeCategoryRelations().CategoryEntityUsingCategoryName, null, new int[] { (int)RecipeCategoryFieldIndex.CategoryName }, null, true, (int)DBFirst.EntityType.CategoryEntity);
				AddNavigatorMetaData<RecipeCategoryEntity, RecipeEntity>("Recipe", "RecipeCategories", (a, b) => a._recipe = b, a => a._recipe, (a, b) => a.Recipe = b, DBFirst.RelationClasses.StaticRecipeCategoryRelations.RecipeEntityUsingRecipeIdStatic, ()=>new RecipeCategoryRelations().RecipeEntityUsingRecipeId, null, new int[] { (int)RecipeCategoryFieldIndex.RecipeId }, null, true, (int)DBFirst.EntityType.RecipeEntity);
			}
		}
