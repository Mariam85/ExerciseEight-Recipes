...
namespace DBFirst.EntityClasses
{
	...
	
	{
		...
		protected class InstructionEntityStaticMetaData : EntityStaticMetaDataBase
		{
			...
			{
				SetEntityCoreInfo("InstructionEntity", InheritanceHierarchyType.None, false, (int)DBFirst.EntityType.InstructionEntity, typeof(InstructionEntity), typeof(InstructionEntityFactory), false);
				AddNavigatorMetaData<InstructionEntity, RecipeEntity>("Recipe", "Instructions", (a, b) => a._recipe = b, a => a._recipe, (a, b) => a.Recipe = b, DBFirst.RelationClasses.StaticInstructionRelations.RecipeEntityUsingRecipeIdStatic, ()=>new InstructionRelations().RecipeEntityUsingRecipeId, null, new int[] { (int)InstructionFieldIndex.RecipeId }, null, true, (int)DBFirst.EntityType.RecipeEntity);
			}
		}
