...
namespace DBFirst.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, DBFirst.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((DBFirst.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public CategoryEntityFactory() : base("CategoryEntity", DBFirst.EntityType.CategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public IngredientEntityFactory() : base("IngredientEntity", DBFirst.EntityType.IngredientEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public InstructionEntityFactory() : base("InstructionEntity", DBFirst.EntityType.InstructionEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeEntityFactory() : base("RecipeEntity", DBFirst.EntityType.RecipeEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public RecipeCategoryEntityFactory() : base("RecipeCategoryEntity", DBFirst.EntityType.RecipeCategoryEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public UserEntityFactory() : base("UserEntity", DBFirst.EntityType.UserEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public VersionInfoEntityFactory() : base("VersionInfoEntity", DBFirst.EntityType.VersionInfoEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(DBFirst.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(DBFirst.EntityType)))
			{
				var factory = GetFactory((DBFirst.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the DBFirst.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(DBFirst.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case DBFirst.EntityType.CategoryEntity:
					return new CategoryEntityFactory();
				case DBFirst.EntityType.IngredientEntity:
					return new IngredientEntityFactory();
				case DBFirst.EntityType.InstructionEntity:
					return new InstructionEntityFactory();
				case DBFirst.EntityType.RecipeEntity:
					return new RecipeEntityFactory();
				case DBFirst.EntityType.RecipeCategoryEntity:
					return new RecipeCategoryEntityFactory();
				case DBFirst.EntityType.UserEntity:
					return new UserEntityFactory();
				case DBFirst.EntityType.VersionInfoEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the DBFirst.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (DBFirst.EntityType)Enum.Parse(typeof(DBFirst.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((DBFirst.EntityType)Enum.Parse(typeof(DBFirst.EntityType), leftOperandEntityName, false), joinType, (DBFirst.EntityType)Enum.Parse(typeof(DBFirst.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (DBFirst.EntityType)Enum.Parse(typeof(DBFirst.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((DBFirst.EntityType)entityTypeValue); }
